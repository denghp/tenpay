...
<div align="center">
  <table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="381" align="left" valign="middle"><a href="https://www.tenpay.com/" target="_blank"><img src="${contextPath}/image/logo.jpg" width="537" height="145" border="0"></a></td>
      ...
      <td align="center" valign="top"><table width="760" border="0" cellspacing="0" cellpadding="3" align="center">
        <tr>
          ...
          <table width="760" height="42" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr> <td height="30" ><span class="STYLE2"><img src="${contextPath}/image/arrow_02_01.gif"> 填写订单信息</span></td>
            </tr>
        </table>
                    ...
                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14">
                        <tr>
                          ...
                          <td width="269" rowspan="8" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="5">
                            <tr>
                              <td height="10" align="center" valign="middle"><img src="${contextPath}/image/cft.gif" width="180" height="81"></td>
                              </tr>
                            <tr>
                      ...
                      <tr>
                        ...
                        <td valign="top"><b>
                          <input name="submit" type="image" src="${contextPath}/image/next.gif" alt="使用财付通安全支付" width="103" height="27">
                        </b></td>
                        <td valign="top">&nbsp;</td>
                      </tr>
                    </table></td>
...
<TABLE width=760 border=0 cellPadding=0 cellSpacing=4 class="px12">
  ...
  <TR>
    ...
    <TD width="120"><IMG alt=中国工商银行 
      src="${contextPath}/image/icon_zggsyh_s.gif" border=0> </TD>
    <TD width="142"><IMG alt=中国建设银行 src="${contextPath}/image/icon_ccb_s.gif" border=0> </TD>
    <TD width="108"><IMG alt=上海浦东发展银行 src="${contextPath}/image/icon_spdb_s.gif"
      border=0> </TD>
    <TD width="142"><IMG alt=招商银行 src="${contextPath}/image/icon_zsyh_s.gif" border=0>    </TD>
    <TD width="141"><IMG alt=中国民生银行 src="${contextPath}/image/icon_cmbc_s.gif"
      border=0></TD>
  </TR>
  <TR>
    <TD>
      <DIV align=left><IMG alt=中国农业银行 
      src="${contextPath}/image/icon_abc_s.gif" border=0> </DIV></TD>
    <TD><IMG alt=广东发展银行 src="${contextPath}/image/icon_gdb_s.gif" border=0> </TD>
    <TD><IMG alt=兴业银行 src="${contextPath}/image/index_38.gif"
      border=0> </TD>
    <TD>
      <DIV align=left><IMG alt=深圳发展银行 
      src="<%=request.getContextPath()%>/image/icon_sdb_s.gif" border=0> </DIV></TD>
  <TD><IMG alt=VISA src="<%=request.getContextPath()%>/image/icon_visa_s.gif" border=0> </TD>
...
<TABLE width=760 border=0 align=center cellPadding=0 cellSpacing=0 class="px12">
  ...
  <TR align="center">
    <TD class="txt12 lh15"><div align="center"><IMG alt="财付通通过“国际权威安全认证” " 
      src="${contextPath}/image/logo_vbvv.gif" border=0><BR>
      财付通通过“国际权威安全 
